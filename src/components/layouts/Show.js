              ...
              <Row>
                <Col lg="6" md="6" sm="6">
                  {data.image[data.image.length - 1] === "4" ? (
                    <video
                      controls
                      width="250"
                      className="w-100 details__video"
                    >
                      <source
                ...
                <Col lg="6" md="6" sm="6">
                  <div className="detail__content">
                    ...
                    <div
                      className="details__author d-flex align-items-center gap-2 "
                      onClick={() => {
                    ...
                    <div
                      className="details__holder d-flex align-items-center gap-3 "
                      onClick={() => {
                    ...
                    <button
                      className="details__buybtn d-flex align-items-center gap-2 w-100"
                      onClick={() =>
                        data.collectable &&
                        dispatch(
                          collectNFT({
                    ...
                    <button
                      className="details__burnbtn d-flex align-items-center gap-2 w-100"
                      onClick={() =>
                        dispatch(
                          burnNFT({
                            Tezos,
