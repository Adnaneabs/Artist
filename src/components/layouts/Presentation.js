  ...
  const imageNFT = selector.map((obj) => (
    <Carousel.Item interval={2500}>
      <img
        ...
        src={`https://ipfs.io/ipfs/${obj.image.split("ipfs://")[1]}`}
        alt={obj.description}
          ...
          <Col lg="6" md="6">
            ...
            <div className="buttons d-flex align-items-center gap-4">
              <button className="explorer d-flex align-items-center gap-2">
                ...
                >
                  Explorer <MdOutlineTravelExplore />{" "}
                </Link>
              </button>

              <button
                className="creation d-flex align-items-center gap-2"
